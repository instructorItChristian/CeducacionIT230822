...
public class laboratorio5c {
	...
	String docPath="..\\CeducacionIT23082022\\Evidencias\\documentoEvidencias.docx";
	WebDriver driver;
	File screen;
	...
	public void irAcontacUs() throws InvalidFormatException, IOException, InterruptedException {
		...
		//captura evidencia
		CapturaEvidencia.capturarPantallaEnDocumento(driver, imagePath + "img.jpg", docPath, "formulario de carga");
		...
		CapturaEvidencia.capturarPantallaEnDocumento(driver, imagePath + "img.jpg", docPath, "resultado");
